    ...
    async mapData() {
        ...
        const data = stations.map((s) => {
            ...
            if (latestAlert) {
                ...
                if (river >= thresholds.criticalRiver || rain >= thresholds.criticalRain)
                    risk = 'CRITICAL';
                else if (river >= thresholds.warningRiver || rain >= thresholds.warningRain)
                    risk = 'WARNING';
                else if (river >= thresholds.watchRiver || rain >= thresholds.watchRain)
                    risk = 'WATCH';
            }
...
], PublicController.prototype, "mapData", null);
