...
const workers_scheduler_1 = require("./workers.scheduler");
...
exports.WorkersModule = WorkersModule = __decorate([
    (0, common_1.Module)({
        imports: [
            bull_1.BullModule.registerQueue({ name: 'predictions' }),
            schedule_1.ScheduleModule.forRoot(),
            processing_module_1.ProcessingModule,
        ],
        providers: [prediction_processor_1.PredictionProcessor, workers_scheduler_1.WorkersScheduler],
    })
], WorkersModule);
